...
function MobileNav({ navSections = [], primaryTabs = [], brandLabel = 'Azoury' }) {
    ...
    <>
      ...
      <header className="lg:hidden sticky top-0 z-30 flex items-center justify-between h-14 px-4 bg-brand-surface/95 backdrop-blur-lg border-b border-brand-border">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-brand-primary text-base">{brandLabel}</span>
        </div>
        <button
          aria-label="Notifications"
          className="relative p-2 -mr-2 rounded-lg text-brand-secondary hover:text-brand-accent active:bg-brand-elevated transition-colors"
        >
            ...
            >
              <div className="flex items-center justify-between h-14 px-4 border-b border-brand-border shrink-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-semibold text-brand-primary">{brandLabel}</span>
                </div>
                <button
                  onClick={closeDrawer}
                  aria-label="Close menu"
                  className="p-2 -mr-2 rounded-lg text-brand-muted hover:text-brand-primary active:bg-brand-elevated transition-colors"
                >
                  <X className="h-5 w-5" />
                </button>
              </div>
              ...
              <div className="border-t border-brand-border shrink-0">
                ...
                <div className="px-3 pb-3">
                  <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-brand-elevated/50">
                  ...
                  <button
                    ...
                    className="mt-2 flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm text-brand-error hover:bg-brand-error/10 transition-colors"
                  >
